...
- Accept similar commands docker i.e ./linux-container run <command to run
inside container>
...
struct argp_option options[] = {
    ...
    {"rootfs", 'r', "FILESYSTEM", 0,
     "Path to the POSIX compliant rootfs to run the container on", 0},
    {"pids-limit", 'p', "MAX PROCESSES", 0,
